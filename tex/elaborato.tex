...
Throughout history, questions regarding the beginning and evolution of our universe have captivated humanity. Indeed, many civilizations have invented creation myths, often featuring some formless void as the original substance that makes up the universe.
\para
...
\para 
The structure of this work mainly follows \cite{casadio-notes}, and incorporates supplementary details found in \cite{wald-relativity} and \cite{carroll-spacetime}. For a more detailed study, the reader is encouraged to consult these works.
...
\para
In these coordinates, using Eq. \eqref{metric_decomposition}, the metric becomes %todo: think about why
\begin{equation}
...
\para
It is also possible to treat dark energy as a perfect fluid, with pressure \[p_{\Lambda} = - \rho_{\Lambda} = \frac{\Lambda}{8 \pi G_N}\] where $\Lambda$ is the cosmological constant and $G_N$ Newton's constant. Since $w = -1$, Eq. \eqref{rho_a_prop} implies
\[
...
to compute the $\mu\nu = 00$ and $\mu\nu = ij$ components of Eq. \eqref{EE}, yielding respectively
\begin{equation}
